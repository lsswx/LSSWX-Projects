    ...
    function ri(e, t) {
        ...
        if (!n || t) {
            ...
            "apple" == e.name) {
                ...
                r.fillStyle = "poison spikes" == e.name ? "rgba(125, 126, 130, 0.57)" : "rgba(125, 126, 130, 0.57)";
                var d = .6 * e.scale;
                ai(r, "spikes" == e.name ? 10 : 6, e.scale, d),
                r.fill(),
                r.stroke(),
                r.fillStyle = "rgba(125, 126, 130, 0.57)",
                si(0, 0, d, r),
                r.fillStyle = "rgba(125, 126, 130, 0.57)",
                si(0, 0, d / 2, r, !0)
            } else if ("windmill" == e.name || "faster windmill" == e.name || "power mill" == e.name)
                r.fillStyle = "rgba(154, 147, 148, 0.54)",
                si(5, 5, e.scale, r),
                r.fillStyle = "rgba(154, 147, 148, 0.54)",
                ...
                r.fillStyle = "rgba(164, 165, 168, 0.53)",
                ...
                r.fill(),
                r.stroke(),
                r.fillStyle = "rgba(176, 170, 135, 0.43)",
...
document.getElementById('gameName').innerHTML = 'AssAssiN';
...
if (item == "h" && data[1] == myPlayer.id) {
        if (data[2] < 66 && data[2] > 0 && AIH == true) {
            doNewSend(["ch", ["AssAssin: Anti insta"]]);
            place(foodType);
            place(foodType);
        ...
        for(let i = 0; i < data[1].length / 13; i++) {
            ...
            if(playerInfo[0] == myPlayer.id) {
                ...
                place(spikeType, angle)
                 doNewSend(["ch", ["AssAssiN: Anti Trap"]]);
                }
              doNewSend(["13c", [0, 53, 0]]);
              setTimeout( () => {
              doNewSend(["13c", [0, 0, 1]]);
...
setInterval(() => {
    ...
    if(alives == 1){
    doNewSend(["ch", ["Minutes:"+count24+",Seconds:"+count23]]);
}
}, 1000);
...
document.getElementById('chatBox').placeholder = "Chating";
...
$("#ageBarContainer").append('</br><div id="hacktext"></div><div style="width: 100%;position: absolute;bottom: 94px;text-align: center;color:gray;font-size: 24px;" id="freetext"></div><div style="width: 100%;position: absolute;bottom: 144px;text-align: center;color: #ed3f00;font-size: 24px;" id="ptext"></div><div style="width: 100%;position: absolute;bottom: 224px;text-align: center;color: #9a008b;font-size: 24px;" id="ctext"></div><div style="width: 100%;position: absolute;top: 100px;text-align: center;color: white;font-size: 12px;" id="bilgitext">MooMoo.io </div><div style="width: 100%;position: absolute;bottom: 170px;text-align: center;color: #00fbff;font-size: 24px;" id="atext"></div><div style="width: 100%;position: absolute;bottom: 196px;text-align: center;color: black;font-size: 24px;" id="mtext"></div>');
(function() {var css = [
	"div#adCard, ",
	"  #twitterFollow, ",
	"  #youtubeFollow, ",
	...
	"  }",
    "    .menucard:hover {",
    "    box-shadow: 0 5px 50px 0 #7f817e inset, 0 5px 50px 0 #7f817e;",
    "               0 5px 50px 0 #7f817e inset, 0 5px 50px 0 #7f817e;",
    "    text-shadow: 0 0 5px #7f817e, 0 0 5px #7f817e;",
    "    background: #7f817e;",
	"    color: black;",
    "   }",
    "",
    ...
    "               0 5px 50px 0 rgba(0, 0, 0, 1) inset, 0 5px 50px 0 rgba(0, 0, 0, 1);",
    "   text-shadow: 0 0 5px black, 0 0 5px black;",
    "    background: #7f817e !important;",//dont copy loser
	"  }",
	"",
	"  #ageBar {",
	"    background-color: rgba(0,0,0,0.6) !important;",
	...
	"  }",
    "  #ageBar:hover {",
	"    background-color: #7f817e !important;",
	"    border: 1px solid black;",
	"    height: 5px;",
	"    padding-bottom: 5px;",
	"    margin-bottom: 3px;",
	...
	"  .allianceItem:hover, ",
	"  .joinAlBtn:hover {",
    "   box-shadow: 0 5px 70px 0 rgba(0, 0, 0, 1) inset, 0 5px 70px 0 black;",
    "               0 5px 70px 0 rgba(0, 0, 0, 1) inset, 0 5px 70px 0 black;",
    "   text-shadow: 0 0 5px #7f817e, 0 0 5px white;",
	...
	"  }",
    "  #promoImgHolder {",
    "   box-shadow: 0 5px 70px 0 rgba(247, 247, 247, 0.32) inset, 0 5px 70px 0 black;",
    "               0 5px 70px 0 rgba(247, 247, 247, 0.32) inset, 0 5px 70px 0 black;",
    "   text-shadow: 0 0 5px #7f817e, 0 0 5px white;",
    ...
    "   box-shadow: 0 5px 70px 0 #7f817e inset, 0 5px 70px 0 #7f817e;",
    "               0 5px 70px 0 #7f817e inset, 0 5px 70px 0 #7f817e;",
    "   text-shadow: 0 0 5px #7f817e, 0 0 5px #7f817e;",
    "    background: #7f817e !important;",
    "    color: #7f817e;",
	"  }",
	"",
