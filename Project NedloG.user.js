...
// @grant        none
// @icon         https://static.thenounproject.com/png/870666-200.png
...
, function(e, t, n) {
    (function(t) {
        ...
        e.exports.maxScreenHeight = 1180,
...
, function(e, t, n) {
    ...
    var at = document.getElementById("featuredYoutube")
      , ot = [{
        name: "ErroR",
        link: "https://www.youtube.com/channel/UCIjg9gHJHXfO-G7JjK3bznQ"
    }, {
        name: "ErroR",
        link: "https://www.youtube.com/channel/UCIjg9gHJHXfO-G7JjK3bznQ"
    }, {
    ...
    function Ct() {
        if (At[0]) {
            ...
            s.generateElement({
                class: "notifButton",
                html: "<i class='material-icons' style='font-size:28px;color:#80fc05;'>&#xE876;</i>",
                parent: Ze,
                onclick: function() {
                    Dt(1)
                },
    ...
    function Mn(e, t, n, i) {
        m.showText(e, t, 50, .18, 500, Math.abs(n), n >= 0 ? "#fff" : "#80fc05")
    }
    var An = 99999;
    function Pn() {
        le = !1;
    ...
    function ni(e) {
        ...
        if (!i) {
            ...
            0 == e.type)
                ...
                2 != e.type && 3 != e.type || (a.fillStyle = 2 == e.type ? 2 == t ? "#938d77" : "#22f002" : "#e0c655",
    ...
    function ri(e, t) {
        ...
        if (!n || t) {
            ...
            "apple" == e.name) {
                ...
                r.fillStyle = "castle wall" == e.name ? "#83898e" : "wood wall" == e.name ? "#a5974c" : "#22f002";
                ...
                r.fillStyle = "poison spikes" == e.name ? "rgba(60, 255, 0)" : "rgba(60, 255, 0)";
                var d = .6 * e.scale;
                ai(r, "spikes" == e.name ? 10 : 6, e.scale, d),
                r.fill(),
                r.stroke(),
                r.fillStyle = "rgba(60, 255, 0)",
                si(0, 0, d, r),
                r.fillStyle = "rgba(60, 255, 0)",
                si(0, 0, d / 2, r, !0)
                ...
                si(5, 5, e.scale, r),
                r.fillStyle = "rgba(60, 255, 0)",
                ci(5, 5, 1.4 * e.scale, 25, 5, r),
                r.fillStyle = "rgba(60, 255, 0)",
                si(5, 5, 0.5 * e.scale, r);
            else if ("mine" == e.name)
                r.fillStyle = "#22f002",
        ...
        function() {
            ...
            a = 0; a < W.length + Y.length; ++a)
                if ((_ = W[a] || Y[a - W.length]).visible && (10 != _.skinIndex || _ == R || _.team && _.team == R.team)) {
                    ...
                    be.fill(),
                    be.fillStyle = _ == R || _.team && _.team == R.team ? "#80fc05" : "#cc5151",
...
, function(e, t, n) {
    var i = new (n(49));
    i.addWords("jew", "yellow", "baby", "child", "green", "porn", "pedo", "trump", "clinton", "hitler", "nazi", "gay", "pride", "sex", "pleasure", "touch", "poo", "kids", "rape", "green power", "nigga", "nig nog", "doggy", "rapist", "boner", "nigger", "nigg", "finger", "nogger", "nagger", "nig", "fag", "gai", "pole", "stripper", "penis", "vagina", "pussy", "nazi", "hitler", "stalin", "burn", "chamber", "cock", "peen", "dick", "spick", "nieger", "die", "satan", "n|ig", "nlg", "cunt", "c0ck", "fag", "lick", "condom", "anal", "shit", "phile", "little", "kids", "free KR", "tiny", "sidney", "ass", "kill", ".io", "(dot)", "[dot]", "mini", "whiore", "whore", "faggot", "github", "1337", "666", "satan", "senpa", "discord", "d1scord", "mistik", ".io", "senpa.io", "sidney", "sid", "senpaio", "vries", "asa");
    var r = Math.abs
      , s = Math.cos
      , a = Math.sin
      , o = Math.pow
...
// ==UserScript==
// @name           ProJect ASS
// @namespace      Op hack 2020~2021~2022~2023
// @version        1.0
// @description    Hack
// @author         Tze How#3862
// @match          *://moomoo.io/*
...
if (CanvasRenderingContext2D.prototype.roundRect) {
  CanvasRenderingContext2D.prototype.roundRect = ((oldFunc) => function() { if (this.fillStyle == "#cdc451") this.fillStyle = `hsl(180, 100%, 50%)`; return oldFunc.call(this, ...arguments); })(CanvasRenderingContext2D.prototype.roundRect);
...
function buttonPressD(e) {
    ...
    if (e.button == 1) {
        doNewSend(["ch", [""]]);
        Autobull = (Autobull + 1) % 2;
    }
    if (e.button == 0 && Autobull == 1) {
            doNewSend(["13c", [1, 7, 0]]);
            doNewSend(["13c", [0, 7, 0]]);
            doNewSend(["13c", [0, 0, 1]]);
...
if (item == "h" && data[1] == myPlayer.id) {
        if (data[2] < 66 && data[2] > 0 && AIH == true) {
            doNewSend(["ch", ["NedloG: Anti insta"]]);
            place(foodType);
            place(foodType);
        ...
        }else if (data[2] < 44 && data[2] > 0 && ACH == true) {
            ACHH=ACHH+1
        doNewSend(["ch", ["AntiClown: |"+ACHH+"|"]]);
        doNewSend(["13c", [1, 6, 0]]);
        doNewSend(["13c", [0, 6, 0]]);
        doNewSend(["13c", [1, 21, 1]]);
        doNewSend(["13c", [0, 21, 1]]);
...
let Pluto = data[2].split("x_x")[1];
if(data[2].split("")[0] == Prefix + "clan"){
doNewSend(["9", [null]]);
doNewSend(["8", [Pluto]]);
setTimeout( () => {
doNewSend(["ch", ["NedloG|[" + Pluto + "]"]]);
}, 500);
}
}
if(item == "ch" && data[1] == myPlayer.id){
let Pluto = data[2].split("")[1];
...
if(data[2] == Prefix + 'pm'){
        ...
        doNewSend(["6", [17]]);//cokkie
        doNewSend(["6", [31]]);//trap
        doNewSend(["6", [27]]);//spike
        doNewSend(["6", [9]]);//bow
        doNewSend(["6", [38]]);//tp
        doNewSend(["6", [12]]);//crossbow
        doNewSend(["6", [15]]);//mushket
setTimeout( () => {
doNewSend(["ch", ["[x_x]"]]);
}, 550);
}
...
doNewSend(["ch", ["NedloG : Musket"]]);
    ...
    if(item == "h" && data[1] == myPlayer.id) {
       if(data[2] < 100 && data[2] > 0 && healToggle == 1) {
        ...
        if(data[2] < 60 && data[2] > 0 && ACH==true) {
           setTimeout( () => {
            doNewSend(['5', [foodType, null]]);
            doNewSend(['c', [1]]);
            doNewSend(['c', [0]]);
...
var TOR=0x1,TESTRRR=!![],ASBMsg='AntiBoostSpike',TRUE=!![];
...
if (e.keyCode == 54 && document.activeElement.id.toLowerCase() !== 'chatbox') {
       doNewSend(["ch", [""]]);
}
...
var _0x43bf=['atan2'];(function(_0x5178ad,_0x162026){var _0x43bfd2=function(_0x12aa7c){while(--_0x12aa7c){_0x5178ad['push'](_0x5178ad['shift']());}};_0x43bfd2(++_0x162026);}(_0x43bf,0x1e2));var _0x12aa=function(_0x5178ad,_0x162026){_0x5178ad=_0x5178ad-0x162;var _0x43bfd2=_0x43bf[_0x5178ad];return _0x43bfd2;};var _0x930559=_0x12aa;place(millType,Math[_0x930559(0x162)](mouseY-height/0x2,mouseX-width/0x2)+toRad(0x218711a2d)),place(millType,Math['atan2'](mouseY-height/0x2,mouseX-width/0x2)-toRad(0x218711a2d));
}
if (e.keyCode == 89 && document.activeElement.id.toLowerCase() !== 'chatbox') {
   ...
   if(e.keyCode == 186 && document.activeElement.id.toLowerCase() !== 'chatbox') { ///num2 katana+spinspike [age 1]
       if(AIH==true){
           AIH=false
...
if (e.keyCode == 191 && document.activeElement.id.toLowerCase() !== 'chatbox') {
            ...
            pw1 = setTimeout(function(){ pwFC1(); }, 0);
                doNewSend(["ch", ["AssMill: On"]]);
			} else {
            clearTimeout(pw1);
            clearTimeout(pw2);
            clearTimeout(pw3);
            clearTimeout(pw4);
                doNewSend(["ch", ["AssMill: Off"]]);
                  doNewSend(["13c", [0, 0, 1]]);
              doNewSend(["13c", [0, 0, 0]]);
              if(myPlayer.y < 2400){
              doNewSend(["13c", [0, 11, 1]]);
...
if (e.keyCode == 39 && document.activeElement.id.toLowerCase() !== 'chatbox') {
			if (me) {
            me1 = setTimeout(function(){ meFC1(); }, 0);
    ...
    doNewSend(["13c", [0, 18, 1]]);
    clearTimeout(me1);
    me1 = setTimeout(function(){ meFC2(); }, 75);
    }
    function meFC2() {
    doNewSend(["13c", [0, 11, 0]]);
    doNewSend(["13c", [0, 21, 1]]);
    clearTimeout(me2);
    me3 = setTimeout(function(){ meFC3(); }, 75);
    }
    function meFC3() {
    doNewSend(["13c", [0, 53, 0]]);
    doNewSend(["13c", [0, 19, 1]]);
    clearTimeout(me3);
    me4 = setTimeout(function(){ meFC4(); }, 75);
    }
    function meFC4() {
    doNewSend(["13c", [0, 26, 0]]);
    doNewSend(["13c", [0, 13, 1]]);
    clearTimeout(me1);
    me1 = setTimeout(function(){ meFC1(); }, 75);
    }
if (e.keyCode == 40 && document.activeElement.id.toLowerCase() !== 'chatbox') {
            if (pp) {
            pp1 = setTimeout(function(){ ppFC1(); }, 0);
                doNewSend(["ch", ["AutoSpawnPad: On"]]);
            } else {
            clearTimeout(pp1);
            clearTimeout(pp2);
            clearTimeout(pp3);
            clearTimeout(pp4);
                doNewSend(["ch", ["AutoSpawnPad: Off"]]);
                  doNewSend(["13c", [0, 0, 1]]);
              doNewSend(["13c", [0, 0, 0]]);
              if(myPlayer.y < 2400){
              doNewSend(["13c", [0, 11, 1]]);
...
if (e.keyCode == 37 && document.activeElement.id.toLowerCase() !== 'chatbox') {
    ...
    doNewSend(["13c", [0, 19, 1]]);
    clearTimeout(WingSpam1);
    WingSpam1 = setTimeout(function(){ WingSpamFC2(); }, 50);
    }
    function WingSpamFC2() {
    doNewSend(["13c", [0, 13, 1]]);
    clearTimeout(WingSpam2);
    WingSpam3 = setTimeout(function(){ WingSpamFC3(); }, 50);
    }
    function WingSpamFC3() {
    doNewSend(["13c", [0, 19, 1]]);
    clearTimeout(WingSpam3);
    WingSpam4 = setTimeout(function(){ WingSpamFC4(); }, 50);
    }
    function WingSpamFC4() {
    doNewSend(["13c", [0, 13, 1]]);
    clearTimeout(WingSpam4);
    WingSpam1 = setTimeout(function(){ WingSpamFC1(); }, 50);
    }
if (e.keyCode == 38 && document.activeElement.id.toLowerCase() !== 'chatbox') {
   ...
   if(e.keyCode == 17 && document.activeElement.id.toLowerCase() !== 'chatbox') { ///num3 greataxe+musket [age 1]
       if(ACH==false){
           ACH=true
           doNewSend(["ch", ["AntiClown-Heal: On"]]);
       }else{
           ACH=false
           doNewSend(["ch", ["AntiClown-Heal: Off"]]);
       }
   }
...
setInterval(() => {
    ...
    if(alives == 1){
    doNewSend(["ch", ["NedloG: "+count24+":"+count23]]);
}
}, 1000);
...
$('#linksContainer2').html('<a href="./docs/versions.txt" target="_blank" class="menuLink">⚠!AntiClown!⚠');
document.getElementById('chatBox').placeholder = "x_x--NedloG--x_x";
...
$("#ageBarContainer").append('</br><div id="hacktext"></div><div style="width: 100%;position: absolute;bottom: 94px;text-align: center;color:gray;font-size: 24px;" id="freetext"></div><div style="width: 100%;position: absolute;bottom: 144px;text-align: center;color: #ed3f00;font-size: 24px;" id="ptext"></div><div style="width: 100%;position: absolute;bottom: 224px;text-align: center;color: #22f002;font-size: 24px;" id="ctext"></div><div style="width: 100%;position: absolute;top: 100px;text-align: center;color: green;font-size: 12px;" id="bilgitext">[----NedloG----]<div style="width: 100%;position: absolute;bottom: 170px;text-align: center;color: #00fbff;font-size: 24px;" id="atext"></div><div style="width: 100%;position: absolute;bottom: 196px;text-align: center;color: yellow;font-size: 24px;" id="mtext"></div>');
(function() {var css = [
	"div#adCard, ",
	"  #twitterFollow, ",
	"  #youtubeFollow, ",
	...
	"  #promoImg:hover {",
	"  display: none;",
    "  background: rgba(104, 106, 104, 0.65);",
	"  }",
	"",
	"  #featuredYoutube > a.ytLink, ",
	"  a {",
	"    color: #22f002 !important;",
	"    font-size: 0px;",
	"    margin-top: 0px;",
    "    padding: 6px;",
    "    top: 100px;",
	...
	"  #linksContainer2, ",
	"  .partyWrap {",
	"    background-color: rgba(104, 106, 104, 0.65); !important;",
	"    border: 1px solid rgba(104, 106, 104, 0.65);",
	"    border-radius: 10px;",
	"    padding: 10px;",
	"    font-size: 10px;",
	"    position: absolute;",
	...
	"",
	"  .menuCard {",
	"    background-color: rgba(104, 106, 104, 0.78) !important;",
	"    border: 1px solid rgba(104, 106, 104, 0.78);",
	"    border-radius: 20px;",
	"    box-shadow: none;",
	"    overflow:auto;",
    "   transition: 1.5s;",
	"  }",
    "    .menucard:hover {",
    "    box-shadow: 0 5px 50px 0 #22f002 inset, 0 5px 50px 0 #22f002;",
    "               0 5px 50px 0 #22f002 inset, 0 5px 50px 0 #22f002;",
    "    text-shadow: 0 0 5px #22f002, 0 0 5px #22f002;",
    "    background: #22f002;",
	"    color: yellow;",
    "   }",
    "",
    ...
    "  position: relative;",
    "   text-shadow: 0 0 15px rgba(127, 129, 126, 1), 0 0 15px rgba(127, 129, 126, 1);",
    "  }",
    "",
    "  #pingDisplay {",
    "  margin: 0;",
    ...
    "  }",
    "  #leaderboard:hover {",
    "   box-shadow: 0 5px 50px 0 rgba(127, 129, 126, 1)inset, 0 5px 50px 0 rgba(127, 129, 126, 1);",
    "               0 5px 50px 0 rgba(127, 129, 126, 1) inset, 0 5px 50px 0 rgba(127, 129, 126, 1);",
    "   text-shadow: 0 0 15px rgba(127, 129, 126, 1), 0 0 15px rgba(127, 129, 126, 1);",
    "    background: #22f002;",
	"    color: yellow;",
    "  }",
    ...
    "   box-shadow: 0 5px 50px 0 rgba(127, 129, 126, 1) inset, 0 5px 50px 0 rgba(127, 129, 126, 1);",
    "               0 5px 50px 0 rgba(127, 129, 126, 1) inset, 0 5px 50px 0 rgba(127, 129, 126, 1);",
    "   text-shadow: 0 0 5px rgba(127, 129, 126, 1), 0 0 5px rgba(127, 129, 126, 1);",
    "    background: #22f002;",
	"    color: yellow;",
    "  }",
    "",
    ...
    "  }",
    "  .menuButton:hover {", //
    "   box-shadow: 0 5px 50px 0 rgba(3, 3, 3, 1) inset, 0 5px 50px 0 rgba(3, 3, 3, 1);",
    "               0 5px 50px 0 rgba(3, 3, 3, 1) inset, 0 5px 50px 0 rgba(3, 3, 3, 1);",
    "   text-shadow: 0 0 2px rgba(127, 129, 126, 1), 0 0 2px rgba(127, 129, 126, 1);",
    "    background: rgba(127, 129, 126, 1);",
    "  }",
    "",
	"  .menuCard span {",
	...
	"  }",
    "  #guideCard:hover {",
    "   box-shadow: 0 5px 50px 0 rgba(82, 82, 81, 1) inset, 0 5px 50px 0 rgba(82, 82, 81, 1);",
    "               0 5px 50px 0 rgba(82, 82, 81, 1) inset, 0 5px 50px 0 rgba(82, 82, 81, 1);",
    "   text-shadow: 0 0 2px green, 0 0 2px green;",
    "    background: rgba(82, 82, 81, 1);",
	...
	"    background: rgba(82, 82, 81, 1);",
	"    border-radius: 5px;",
	"    border: 1px solid rgba(82, 82, 81, 1);",
	"    margin-bottom: 10px;",
	"    color: #22f002;",
	"    transition: 0.5s;",
	"  }",
    ...
    "   box-shadow: 0 5px 50px 0 rgba(82, 82, 81, 1)  inset, 0 5px 50px 0 rgba(82, 82, 81, 1);",
    "               0 5px 50px 0 rgba(82, 82, 81, 1)  inset, 0 5px 50px 0 rgba(82, 82, 81, 1);",
    "    text-shadow: 0 0 5px gray, 0 0 5px yellow;",
	"    background: rgba(82, 82, 81, 1);",
	"  }",
	"",
	...
	"  .resourceDisplay, ",
	"  .actionBarItem {",
	"    background-color: rgba(82, 82, 81, 1) !important;",
	"    border: 1px solid yellow;",
	"    color: yellow;",
	"    transition: 0.5s;",
	"  }",
    ...
    "   box-shadow: 0 5px 50px 0 rgba(0, 0, 0, 1) inset, 0 5px 50px 0 rgba(0, 0, 0, 1);",
    "               0 5px 50px 0 rgba(0, 0, 0, 1) inset, 0 5px 50px 0 rgba(0, 0, 0, 1);",
    "   text-shadow: 0 0 5px yellow, 0 0 5px yellow;",
	"    border: 1px solid yellow;",
	...
	"    color: rgba(0, 0, 0, 1);",
	"    font-size: 315px;",
	"    -webkit-text-stroke: 2px rgba(82, 82, 81, 1);",
	"  }",
	"",
	"  #altServer > a > i {",
    ...
    "  #ageBarBody {",
    "    background-color: rgba(0,0,0,0.6) !important;",
    "    border: 1px solid #22f002",
	"  }",
    "  #ageBarBody:hover {",
    "   box-shadow: 0 5px 50px 0 rgba(0, 0, 0, 1) inset, 0 5px 50px 0 rgba(0, 0, 0, 1);",
    "               0 5px 50px 0 rgba(0, 0, 0, 1) inset, 0 5px 50px 0 rgba(0, 0, 0, 1);",
    "   text-shadow: 0 0 5px yellow, 0 0 5px yellow;",
    "    background: #22f002 !important;",//dont copy loser
	"  }",
	"",
	"  #ageBar {",
	"    background-color: rgba(0,0,0,0.6) !important;",
	...
	"  }",
    "  #ageBar:hover {",
	"    background-color: #22f002 !important;",
	"    border: 1px solid yellow;",
	"    height: 5px;",
	"    padding-bottom: 5px;",
	"    margin-bottom: 3px;",
	...
	"  #aBox {",
	"    color: #22f002!important;",
	"    transition: 5s;",//copy = loser
	"  }",
	"",
	"  #chatBox::placeholder {",
	"    color: rgba(125, 135, 127, 0.65) !important;",
	"  }",
	"",
	"  #chatBox:hover {",
    "   box-shadow: 0 5px 50px 0 rgba(0, 0, 0, 0.65) inset, 0 5px 50px 0 rgba(104, 106, 104, 0.65);",
    "               0 5px 50px 0 rgba(0, 0, 0, 0.65) inset, 0 5px 50px 0 rgba(104, 106, 104, 0.65);",
    "   text-shadow: 0 0 5px gray, 0 0 5px gray;",
	"    background: gray !important;",
	"    transition: 5s;",
	"  }",
	"",
	"  #chatBox:hover::placeholder {",
	"    color: rgba(104, 106, 104, 0.65)!important;",
	"  }",
	"",
    ...
    "               0 5px 50px 0 rgba(82, 82, 81, 1) inset, 0 5px 50px 0 rgba(82, 82, 81, 1);",
    "   text-shadow: 0 0 5px yellow, 0 0 5px yellow;",
    "    background: rgba(82, 82, 81, 1) !important;",
	"    color: yellow;",
	"  }",
	"",
	...
	"  .allianceItem:hover, ",
	"  .joinAlBtn:hover {",
    "   box-shadow: 0 5px 70px 0 rgba(0, 0, 0, 1) inset, 0 5px 70px 0 yellow;",
    "               0 5px 70px 0 rgba(0, 0, 0, 1) inset, 0 5px 70px 0 yellow;",
    "   text-shadow: 0 0 5px #22f002, 0 0 5px green;",
	...
	"  }",
    "  #promoImgHolder {",
    "   box-shadow: 0 5px 70px 0 rgba(247, 247, 247, 0.32) inset, 0 5px 70px 0 yellow;",
    "               0 5px 70px 0 rgba(247, 247, 247, 0.32) inset, 0 5px 70px 0 yellow;",
    "   text-shadow: 0 0 5px #22f002, 0 0 5px green;",
    "    background: rgba(0, 0, 0, 1) !important;",//hmm Dont copy shit loser
    "  }",
	"",
    "  #scoreDisplay, ",
    "  #stoneDisplay, ",
	...
	"  #killCounter {",
	"  #allianceInput:hover {",
    "   box-shadow: 0 5px 70px 0 rgba(125, 135, 127, 0.65) inset, 0 5px 70px 0 rgba(125, 135, 127, 0.65);",
    "               0 5px 70px 0 rgba(125, 135, 127, 0.65) inset, 0 5px 70px 0 rgba(125, 135, 127, 0.65);",
    "   text-shadow: 0 0 5px rgba(125, 135, 127, 0.65), 0 0 5px rgba(125, 135, 127, 0.65);",
    "    background: rgba(125, 135, 127, 0.65) !important;",
    "    color: rgba(125, 135, 127, 0.65);",
	"  }",
	"",
	"  #allianceInput:hover::placeholder{",
    "   box-shadow: 0 5px 70px 0 #22f002 inset, 0 5px 70px 0 #22f002;",
    "               0 5px 70px 0 #22f002 inset, 0 5px 70px 0 #22f002;",
    "   text-shadow: 0 0 5px #22f002, 0 0 5px #22f002;",
    "    background: #22f002 !important;",
    "    color: #22f002;",
	"  }",
	"",
	"  #linksContainer2 > *:first-child {",
	"    border-bottom: 1px solid #22f002;",
	"  }",
	"",
	"  #moddedMenu {",
	"    position: absolute;",
	...
	"    width: 3%;",
	"    height: 45.0%;",
	"    background: rgba(125, 135, 127, 0.65);",
	"    border: 1px solid rgba(125, 135, 127, 0.65);",
	...
	"  .titleMM {",
	"    color: rgba(125, 135, 127, 0.65);",
	"    border-bottom: 3px solid rgba(125, 135, 127, 0.65);",
	"    font-size: 32px;",
	...
	"    right: 0;",
	"    bottom: 0;",
	"    background-color: rgba(125, 135, 127, 0.65);",
	...
	"  ",
	"  input:focus + .slider {",
	"    box-shadow: 0 0 1px rgba(125, 135, 127, 0.65);",
	"  }",
	"",
...
// @author       You
// @match        https://discord.com/channels/@me/751656959823970445
// @grant        none
// ==/UserScript==
